  ...
  return (
    <section className="mt-12 w-full">
      <div className="mx-auto max-w-4xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-green-700 p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-white mb-6">Tu fais chichi pour les balades en groupe?</h2>
              <p className="text-white/60 mb-8">On a la solution pour toi.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
