      ...
      <section className="relative overflow-hidden min-h-screen flex flex-col">
        <div
          ...
          style={{
            ...
            opacity: bikePosition < 0 || bikePosition > 105 ? 0 : 1
          }}
        >
          <img
            src="/bike-ride.svg"
            ...
            >
              ...
              <div className="flex items-center justify-center">
                  ...
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                    ...
                    <div className="text-yellow-400 group-hover:ml-4 ease-in-out transition-all size-[24px] flex items-center justify-center rounded-full border-2 border-border">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
