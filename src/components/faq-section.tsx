              ...
              <div className="flex items-start justify-between">
                ...
                >
                  {openItems.includes(index) ? (
                    <Minus className="text-yellow-400 flex-shrink-0 transition duration-300" size={24} />
                  ) : (
                    <Plus className="text-yellow-400 flex-shrink-0 transition duration-300" size={24} />
                  )}
                </motion.div>
              </div>
              <AnimatePresence>
